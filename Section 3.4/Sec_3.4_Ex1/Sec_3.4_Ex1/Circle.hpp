...
#ifndef __Sec3_4_Ex1__Circle__
#define __Sec3_4_Ex1__Circle__
...
public:
    ...
    string ToStringCircle() const; //Return string description of circle
...
#endif /* defined(__Sec2_4_Ex4__Circle__) */
