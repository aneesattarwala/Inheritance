...
// using virtual functions  calling base class functionality
...
int main()
{
    ...
    cout<<sp->ToString()<<endl; // What is printed? ->ID: 74 Point(10,20) is printed as ToString is declared virtual and also calls Shape::ToString() function.
    ...
    // the base class assignment in point? -> No it is not copied, as base class part is not assigned
    return 0;
}
